...
exports.create = async function(name, chatBot, options) {
	...
	trigger.db = await (async function(){try{return JSON.parse(await readFileAsync(trigger.options.dbFile));}catch(err){return {}}})();
	return trigger;
};
